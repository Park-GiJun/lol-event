...
import { findLockfile, parseLockfile, lcuGet } from './lcu';
...
let champCache: Record<string, string> | null = null;
async function getChampMap(): Promise<Record<string, string>> {
