      ...
      <div className="m-more-grid">
        {ITEMS.map(({ to, icon: Icon, label, desc }) => (
          <button
            ...
            onClick={() => navigate(to)}
            style={{ background: 'var(--color-bg-card)', border: '1px solid var(--color-border)', borderRadius: 12, padding: '20px 12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10, cursor: 'pointer', transition: 'background 0.15s', width: '100%' }}
          >
