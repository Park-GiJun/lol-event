      ...
      {data.map(c => (
        <div key={c.championId} className="col-span-4" style={{ textAlign: 'center', padding: '6px 4px' }}>
          {c.imageUrl ? (
            ...
            <div style={{ width: 52, height: 52, borderRadius: 8, background: 'var(--color-bg-tertiary)', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, color: 'var(--color-text-disabled)' }}>
              {c.nameKo.slice(0, 2)}
            </div>
          )}
      ...
      {data.map(item => (
        <div key={item.itemId} className="col-span-4" style={{ textAlign: 'center', padding: '6px 4px' }}>
          {item.imageUrl ? (
            ...
            <div style={{ width: 52, height: 52, borderRadius: 8, background: 'var(--color-bg-tertiary)', margin: '0 auto' }} />
          )}
          <div style={{ fontSize: 10, color: 'var(--color-text-secondary)', marginTop: 4, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {item.nameKo}
          </div>
