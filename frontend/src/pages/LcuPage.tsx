  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: 'var(--spacing-md)' }}>
        ...
        <p style={{ color: 'var(--color-text-secondary)', fontSize: 'var(--font-size-sm)', marginBottom: 'var(--spacing-md)', lineHeight: 1.7 }}>
          수집기는 <strong style={{ color: 'var(--color-text)' }}>로컬 PC</strong>에서 실행되는 프로그램입니다.
      ...
      <div className="card">
        ...
        <ol style={{ paddingLeft: '20px', color: 'var(--color-text-secondary)', fontSize: 'var(--font-size-sm)', lineHeight: 2.2 }}>
          <li>위 버튼으로 수집기 설치</li>
          <li>수집기 실행 — 시스템 트레이에 아이콘 표시됨</li>
          <li>LoL 클라이언트 실행 후 로그인</li>
          <li>수집기 창에서 <strong style={{ color: 'var(--color-primary)' }}>수집 시작</strong> 버튼 클릭</li>
